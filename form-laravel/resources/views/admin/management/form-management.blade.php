        ...
        <div class="card">
            <table class="table table-bordered" id="taskTable">
                ...
                <tbody id="taskBody">
                    ...
                    {{-- Baris template untuk tambah tugas --}}
                    <tr>
                        <td><input type="text" name="judul_tugas[]" placeholder="Judul Tugas" class="form-control"></td>
                        <td><input type="text" name="deskripsi_tugas[]" placeholder="Deskripsi" class="form-control"></td>
