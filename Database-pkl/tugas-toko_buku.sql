...
ALTER TABLE Buku ADD COLUMN rating_buku DECIMAL(2,1) DEFAULT 0.0;
-- [Tulis perintah SQL Anda di sini]
-- Verifikasi Soal 1.1:
DESC Buku;
...
-- Tulis perintah ALTER TABLE Anda di bawah ini:
ALTER TABLE Pelanggan MODIFY COLUMN email VARCHAR(300);
-- [Tulis perintah SQL Anda di sini]
-- Verifikasi Soal 1.2:
DESC Pelanggan;
...
-- Tulis perintah ALTER TABLE Anda di bawah ini:
ALTER TABLE TransaksiPenjualan ADD COLUMN catatan_admin TEXT;
-- [Tulis perintah SQL Anda di sini]
-- Verifikasi Soal 1.3:
...
-- Tulis perintah ALTER TABLE Anda di bawah ini:
ALTER TABLE TransaksiPenjualan DROP COLUMN catatan_admin;
-- [Tulis perintah SQL Anda di sini]
-- Verifikasi Soal 1.4:
DESC TransaksiPenjualan;
...
-- [Tulis perintah SQL Anda di sini]
UPDATE Buku SET harga = 95000.00, stok = 22 WHERE JUDUL = 'Laskar Pelangi';
...
-- [Tulis perintah SQL Anda di sini]
DELETE FROM TransaksiPenjualan WHERE tanggal_transaksi < '2024-07-05';
...
-- Goal: Tampilkan hanya kolom 'judul' dan 'penulis' dari tabel 'Buku'.
-- Tulis perintah SELECT Anda di bawah ini:
...
-- [Tulis perintah SQL Anda di sini]
SELECT judul, harga FROM Buku WHERE harga > 100000.00;
...
-- [Tulis perintah SQL Anda di sini]
SELECT judul, stok FROM Buku WHERE penulis = 'Tere liye' AND stok < 15;
...
-- [Tulis perintah SQL Anda di sini]
SELECT nama FROM Pelanggan WHERE email LIKE '%@example.com' OR nama LIKE '%Siti%';
...
-- [Tulis perintah SQL Anda di sini]
SELECT judul FROM Buku WHERE NOT harga < 70000.00;
...
-- [Tulis perintah SQL Anda di sini]
SELECT nama FROM Pelanggan WHERE id_pelanggan IN (1, 3, 5);
...
-- [Tulis perintah SQL Anda di sini]
SELECT judul FROM Buku WHERE judul LIKE '%F%';
...
-- [Tulis perintah SQL Anda di sini]
SELECT nama FROM Pelanggan WHERE nama LIKE '%di%';
...
-- Tulis perintah SELECT Anda di bawah ini:
-- [Tulis perintah SQL Anda di sini]
SELECT harga FROM Buku ORDER BY harga DESC;
...
-- [Tulis perintah SQL Anda di sini]
SELECT COUNT(*) AS total_jumlah_buku FROM Buku;
...
-- [Tulis perintah SQL Anda di sini]
SELECT penulis, COUNT(*) AS jumlah_buku FROM Buku GROUP BY penulis;
